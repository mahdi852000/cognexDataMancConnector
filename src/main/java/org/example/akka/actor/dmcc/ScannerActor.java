    ...
    public class ScannerActor extends AbstractBehavior<ScannerCommand> implements Behaviour<IResource>, TcpConnector{
        ...
        /**
         * (Possibly unused) Registers message handlers for managing event listeners in the Scanner actor.
         * <p>
         ...
         * <p>
         * Note: Currently unused. Consider removing if not required elsewhere.
         *
         * @param builder the ReceiveBuilder to which listener management handlers would be added
        ...
        private ReceiveBuilder<ScannerCommand> occupationHandlers(ReceiveBuilder<ScannerCommand> builder) {
            return builder
                    ...
                    // This handler is currently inactive. Consider removing if no longer needed.
        ...
        public Receive<ScannerCommand> createReceive() {
            ...
            // listenerHandlers(builder);// Unused setup — can likely be removed if
            // listener registration is no longer needed.
        ...
        /**
         * Handles the GetOccupation command by logging the actor's current occupation status.
         * <p>
         * Currently not used in this module but kept commented for potential reuse.
         * Other parts of the system might still require occupation state tracking.
